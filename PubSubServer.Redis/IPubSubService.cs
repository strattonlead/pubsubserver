...
namespace PubSubServer.Redis
{
    public interface IPubSubService
    {
        ...
        Task SubscribeAsync(string channel, Func<Task> callback, CancellationToken cancellationToken = default);
        Task SubscribeAsync<T>(string channel, Func<T, Task> callback, CancellationToken cancellationToken = default);
        Task SubscribeAsync(string channel, Func<string, Task> callback, CancellationToken cancellationToken = default);
