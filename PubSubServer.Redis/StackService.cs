...
{
    public class StackService : IStackService, IDisposable
    {
        #region Properties
        ...
        public StackService(IServiceProvider serviceProvider)
        {
        ...
        {
            return await _database.ListRightPopAsync(queueName);
        }
